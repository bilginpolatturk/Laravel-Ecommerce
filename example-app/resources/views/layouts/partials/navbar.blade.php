            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#" onclick="(e)=>{e.preventDefault()}; document.getElementById('logout-form').submit()">Çıkış</a>
                            <form id="logout-form" method="post" style="display: none;" action="{{ route('kullanici.oturumukapat') }}">,
                            {{ csrf_field() }}
                            </form>
