                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="adsoyad" name="adsoyad" value="{{ auth()->user()->adsoyad }}" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="adres">Adres</label>
                                <input type="text" class="form-control" id="adres" name="adres" value="{{ $kullanici_detay->adres }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" id="telefon" value="{{ $kullanici_detay->telefon }}" name="telefon" >
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="ceptelefonu">Cep Telefonu</label>
                                <input type="text" class="form-control telefon" id="ceptelefonu" value="{{ $kullanici_detay->ceptelefonu }}" name="ceptelefonu" required>
                            </div>
                        </div>
                    </div>
                </div>
